...
void main()
{
 ...
 lcd_cmd(0x06);
 lcd_cmd(0x01);
 const unsigned char first_lineof_txt [16] =
 { 'H', 'e', 'l', 'l', 'o',' ', 'W', 'o', 'r', 'l', 'd', '!', ' ', ' ', ' ', 0x00 };
 const unsigned char second_lineof_txt [16] =
 { 'H', 'o', 'm', 'e', ' ','A','L', 'O', 'N', 'E', ' ', ' ', ' ', ' ', ' ', 0x00 };
    while(1)
    {
     lcd_cmd(0x80);
     display_message(first_lineof_txt);

     lcd_cmd(0xC0);
     display_message(second_lineof_txt);
